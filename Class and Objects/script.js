...
// Creates a string variable containing the object property values
const content = "<h1>" + caliburnPod.brand + "</h1>";

document.body.innerHTML = content; //injects the content to the HTML file
